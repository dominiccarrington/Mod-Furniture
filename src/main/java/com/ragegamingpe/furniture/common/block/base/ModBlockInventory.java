...
import com.ragegamingpe.furniture.common.block.te.base.TEBasicInventory;
...
public abstract class ModBlockInventory extends ModBlockContainer
{
    ...
    {
        if (!worldIn.isRemote) {
            playerIn.openGui(Furniture.instance, getGuiID(), worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
